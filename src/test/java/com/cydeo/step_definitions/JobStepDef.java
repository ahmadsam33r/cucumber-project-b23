...
public class JobStepDef {
    ...
    @Given("student attent all the classes")
    public void student_attent_all_the_classes() {

        System.out.println("Given code goes here : student attent all the classes ");
    ...
    public void student_upload_their_resume() {
        ...
        System.out.println("When: student upload thier resume");
